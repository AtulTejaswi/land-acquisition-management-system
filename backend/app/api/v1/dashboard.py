...
from app.models.project import Project, Milestone, Ministry, ProjectCategory, ProjectStatus
...
@router.get("/national", response_model=NationalDashboardResponse)
...
@router.get("/state/{state_id}", response_model=StateDashboardResponse)
