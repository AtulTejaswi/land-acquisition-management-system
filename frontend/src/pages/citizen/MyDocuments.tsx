  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <p className="text-slate-500 text-sm">Access all documents related to your land acquisition</p>
      </motion.div>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <EmptyState
              ...
              description="Documents related to your land parcels will appear here once uploaded by the authorities."
            />
          ) : (
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-500">
                        {doc.doc_type?.replace(/_/g, ' ').toUpperCase()} • v{doc.version} • {formatDate(doc.created_at)}
                      </div>
                    </div>
                  </div>
